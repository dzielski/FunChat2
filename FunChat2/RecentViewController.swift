...
//  funChat
//
//  Created by David Zielski on 5/18/16.
...
class RecentViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, ChooseUserDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        performSegueWithIdentifier("recentToChatSeq", sender: indexPath)
    }
    ...
    @IBAction func startNewChatTapped(sender: AnyObject) {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "recentToChatSeq"
        {
